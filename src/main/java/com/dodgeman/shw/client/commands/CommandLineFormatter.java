...
public class CommandLineFormatter {
    ...
    public static MutableComponent formatWaypoint(WaypointName waypointName) {
        return new TextComponent(waypointName.value())
    ...
    public static MutableComponent formatCommand(String... command) {
        return new TextComponent("/" + String.join(" ", command))
    ...
    public static MutableComponent formatNbOfWaypoints(int numberOfWaypoints, int maximumNumberOfWaypoints) {
        return new TextComponent(String.format("(%d/%d)", numberOfWaypoints, maximumNumberOfWaypoints))
    ...
    public static MutableComponent formatPermitted(boolean isPermitted) {
        return isPermitted
                ? new TranslatableComponent("shw.commands.config.permitted").withStyle(ChatFormatting.DARK_GREEN)
                : new TranslatableComponent("shw.commands.config.not_permitted").withStyle(ChatFormatting.RED);
    }
}
