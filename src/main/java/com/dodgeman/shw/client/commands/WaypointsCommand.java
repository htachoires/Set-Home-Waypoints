...
public class WaypointsCommand {
    ...
    public static int setWaypoint(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (playerHomeAndWaypoints.hasWaypointNamed(waypointName)) {
            context.getSource().sendFailure(new TranslatableComponent("shw.commands.waypoints.set.error.duplicateWaypoint", CommandLineFormatter.formatWaypoint(waypointName)));
        ...
        if (playerHasReachMaximumWaypoints) {
            context.getSource().sendFailure(new TranslatableComponent("shw.commands.waypoints.set.error.maximumNumberOfWaypoints", ShwConfigWrapper.getMaxNbOfWaypoints()));
        ...
        if (!playerHomeAndWaypoints.hasAlreadySetWaypoint()) {
            successMessage = new TranslatableComponent("shw.commands.waypoints.set.success.first_waypoint", CommandLineFormatter.formatCommand(COMMAND_NAME, COMMAND_USE_NAME, waypointName.value())).withStyle(ChatFormatting.GREEN);
        }
        ...
        if (successMessage == null) {
            successMessage = new TranslatableComponent("shw.commands.waypoints.set.success", CommandLineFormatter.formatWaypoint(waypointName), CommandLineFormatter.formatNbOfWaypoints(playerHomeAndWaypoints.getNbOfWaypoints(), ShwConfigWrapper.getMaxNbOfWaypoints())).withStyle(ChatFormatting.GREEN);
        }
        ...
        if (lastDeletedWaypoint != null && lastTimeUndoInformation >= TIME_BEFORE_SHOWING_UNDO_INFORMATION) {
            ...
            context.getSource().sendSuccess(new TranslatableComponent("shw.commands.waypoints.set.info.undo", CommandLineFormatter.formatWaypointItalic(waypointName), CommandLineFormatter.formatWaypointItalic(lastDeletedWaypoint.name())).withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.ITALIC), false);
        }
    ...
    public static int useWaypoint(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (waypoint == null) {
            context.getSource().sendFailure(new TranslatableComponent("shw.commands.waypoints.use.error.waypointNotFound", CommandLineFormatter.formatWaypoint(waypointName)));
        ...
        if (!ShwConfigWrapper.isDimensionalTravelAllowedForWaypoints() &&
            ...
            context.getSource().sendFailure(new TranslatableComponent("shw.commands.waypoints.use.error.dimensionalTravelNotAllowed"));
        ...
        if (cooldownRemaining > 0) {
            context.getSource().sendFailure(new TranslatableComponent("shw.commands.waypoints.use.error.cooldown", TimeUnit.MILLISECONDS.toSeconds(cooldownRemaining) + 1, CommandLineFormatter.formatWaypoint(waypointName)));
        ...
        context.getSource().sendSuccess(new TranslatableComponent("shw.commands.waypoints.use.success", waypointName.value()), false);
        ...
        if (lastDeletedWaypoint != null && elapsedTimeOfLastUndoInfo >= TIME_BEFORE_SHOWING_UNDO_INFORMATION) {
            playerHomeAndWaypoints.undoInformationHasBeenShown();
            context.getSource().sendSuccess(new TranslatableComponent("shw.commands.waypoints.use.info.undo", CommandLineFormatter.formatWaypointItalic(waypointName), CommandLineFormatter.formatWaypointItalic(lastDeletedWaypoint.name())).withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.ITALIC), false);
        }
    ...
    public static int updateWaypoint(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (!playerHomeAndWaypoints.hasWaypointNamed(waypointName)) {
            context.getSource().sendFailure(new TranslatableComponent("shw.commands.waypoints.update.error.waypointNotFound", CommandLineFormatter.formatWaypoint(waypointName)));
        ...
        context.getSource().sendSuccess(new TranslatableComponent("shw.commands.waypoints.update.success", CommandLineFormatter.formatWaypoint(waypointName)).withStyle(ChatFormatting.GREEN), false);

        long elapsedTimeOfLastUndoInfo = new Date().getTime() - playerHomeAndWaypoints.getUndoInformationHasBeenShownAt();

        if (lastDeletedWaypoint != null && elapsedTimeOfLastUndoInfo >= TIME_BEFORE_SHOWING_UNDO_INFORMATION) {
            playerHomeAndWaypoints.undoInformationHasBeenShown();
            context.getSource().sendSuccess(new TranslatableComponent("shw.commands.waypoints.update.info.undo", CommandLineFormatter.formatWaypointItalic(waypointName), CommandLineFormatter.formatWaypointItalic(lastDeletedWaypoint.name())).withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.ITALIC), false);
        }
    ...
    public static int listWaypoints(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        MutableComponent successMessage = new TextComponent("/" + COMMAND_NAME + " " + COMMAND_USE_NAME + " [ ");
    ...
    public static int removeWaypoint(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (!playerHomeAndWaypoints.hasWaypointNamed(waypointName)) {
            context.getSource().sendFailure(new TranslatableComponent("shw.commands.waypoints.remove.error.waypointNotFound", CommandLineFormatter.formatWaypoint(waypointName)));
        ...
        context.getSource().sendSuccess(new TranslatableComponent("shw.commands.waypoints.remove.success." + successMessageIndex, CommandLineFormatter.formatWaypoint(waypointName), CommandLineFormatter.formatWaypoint(waypointName)), false);
        ...
        if (elapsedTimeOfLastUndo >= TIME_BEFORE_SHOWING_UNDO_REMINDER || lastTimeDeletedWaypoint == 0) {
            context.getSource().sendSuccess(
                    new TranslatableComponent("shw.commands.waypoints.remove.info.undo",
    ...
    public static int clearWaypoints(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        context.getSource().sendSuccess(new TranslatableComponent("shw.commands.waypoints.clear.success"), false);
    ...
    public static int undoDeletedWaypoint(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (!playerHomeAndWaypoints.hasLastDeletedWaypoint()) {
            context.getSource().sendFailure(new TranslatableComponent("shw.commands.waypoints.undo.error.noLastWaypointDeletedFound"));
        ...
        context.getSource().sendSuccess(
                new TranslatableComponent("shw.commands.waypoints.undo.success",
    ...
    public static int showConfiguration(CommandContext<CommandSourceStack> context) {
        context.getSource().sendSuccess(
                new TranslatableComponent(
                        ...
                        new TextComponent(String.valueOf(ShwConfigWrapper.getWaypointsCooldown())).withStyle(ChatFormatting.BLUE),
                        new TextComponent(String.valueOf(ShwConfigWrapper.getMaxNbOfWaypoints())).withStyle(ChatFormatting.BLUE),
    ...
    public static int configureCooldown(CommandContext<CommandSourceStack> context) {
        ...
        for (ServerPlayer player : context.getSource().getServer().getPlayerList().getPlayers()) {
            player.sendMessage(new TranslatableComponent("shw.commands.waypoints.config.cooldown.success", CommandLineFormatter.formatCommand(COMMAND_NAME, COMMAND_USE_NAME), new TextComponent(String.valueOf(cooldownValue))).withStyle(ChatFormatting.GRAY), player.getUUID());
        }
    ...
    public static int configureDimensionalTravel(CommandContext<CommandSourceStack> context) {
        ...
        for (ServerPlayer player : context.getSource().getServer().getPlayerList().getPlayers()) {
            player.sendMessage(new TranslatableComponent("shw.commands.waypoints.config.dimensionalTravel.success", CommandLineFormatter.formatCommand(COMMAND_NAME, COMMAND_USE_NAME), new TextComponent(String.valueOf(dimensionalTravel))).withStyle(ChatFormatting.GRAY), player.getUUID());
        }
    ...
    public static int configureMaxNbOfWaypoints(CommandContext<CommandSourceStack> context) {
        ...
        for (ServerPlayer player : context.getSource().getServer().getPlayerList().getPlayers()) {
            player.sendMessage(new TranslatableComponent("shw.commands.waypoints.config.maximumNumberOfWaypoints.success", new TextComponent(String.valueOf(maxNbOfWaypoints))).withStyle(ChatFormatting.GRAY), player.getUUID());
        }
